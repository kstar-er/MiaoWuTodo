<template>
  <div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <!-- 自定义选择器底部actions -->
            <template #footer v-if="item.footerAdd">
              ...
              <template v-else>
                <el-input
                  ...
                  class="option-input"
                  :placeholder="`请输入自定义${item.title}`"
                  size="small"
                />
                <div class="options-footer-btn">
                  <el-button type="btn-base btn-primary" size="small" @click="onConfirmInput(item.options)">
                    确认
                  </el-button>
                  <el-button type="btn-base btn-danger" size="small" @click="clearInput">取消</el-button>
                </div>
              </template>
            </template>
    ...
    <div class="footer-btn">
      <el-button
        type="primary"
        style="float: right; margin-right: 25px; width: 70px;"
        @click="submitForm"
...
import { Warning, Edit, Plus, Delete, Picture } from "@element-plus/icons-vue";
...
const onConfirmInput = (options) => {
  if (selectOptionName.value) {
    options.push({
      label: selectOptionName.value,
      value: selectOptionName.value,
    });
    clearInput();
  }
}
